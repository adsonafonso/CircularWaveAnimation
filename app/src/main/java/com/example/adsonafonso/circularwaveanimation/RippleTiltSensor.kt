...
/**
 * Use the Acceleration and Magnetic sensor to get the phone's orientation and to
 * determine how much to translate the gradient as we tilt the phone.
 */
class RippleTiltSensor(context: Context) : SensorEventListener, TiltSensor {
    ...
    override fun onSensorChanged(event: SensorEvent?) {
        ...
        val pitchInRad = orientationAngles[1].toDouble() //rotation about the x axis
        val rollInRad = orientationAngles[2].toDouble() //rotation about the y axis
